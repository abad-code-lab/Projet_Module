                    ...
                    <div className="card-content">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="row">
                                <div className="col 6">
                                    ...
                                    {["Enseignant", "Vacataire", "Etudiant"].map((option) => (
                                        <label key={option}>
                                            <input type="radio" value={option} checked={type === option} onChange={(e) => setType(e.target.value)} />
                                            <span>{option}</span>
                                        </label>
                                    ))}
                                </div>
                            ...
                            <div className="input-field center-align">
                                ...
                                <button className="btn red" type="button" onClick={() => onCancel(false)}>
                                    <i className="material-icons left">cancel</i> Annuler
                                </button>
                            </div>
                        </form>
                    </div>
