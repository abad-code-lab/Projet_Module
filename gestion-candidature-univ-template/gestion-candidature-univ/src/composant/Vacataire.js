...
import { createUsers, deleteUser, getUsers, getVacataires, statusUserPatcheur } from "../ServiceAPi/Microservice-User";
...
const Vacataire = () => {
  ...
  const currentList = listUsers
    .filter((u) => (u?.matricule + ' ' + u.prenom + ' ' + u.nom).toLowerCase().includes(searchTerm.toLowerCase()))
          ...
          <div className="container">
            <div className="row">
              <div className="col s12 m6 l6">
                <h5 className="breadcrumbs-title mt-0 mb-0"><span>Gestion des Vacataires</span></h5>
              </div>
                    ...
                    <div id="view-validations">
                      <form className="formValidate" id="formValidate" method="post">
                        <div className="row">
                          ...
                          <div className="row">
                            <div className="input-field  col s6">
                              <label htmlFor="password">Titre ou Profession *</label>
                  ...
                  <div className="card-content">
                    ...
                    <div className="responsive-table">
                      <table id="users-list-datatable" className="highlight responsive-table striped responsive-table striped">
                        ...
                        <tbody>
                          {currentList.map((utilisateur, index) => (<tr key={index}><td></td> <td>
                            <button
                            ...
                            <td><span className="chip yellow lighten-5"><span className="black-text"> {utilisateur.titreOuProfession || 'A definir'} </span></span></td>
